...
const base =
  'inline-flex items-center justify-center gap-2 font-medium uppercase tracking-caps transition disabled:cursor-not-allowed disabled:opacity-40'
...
export default function Button({
  ...
  const classes = clsx(base, sizes[size], styles[variant], className)
